...
* TinyMCE
* Iris
* Lodash/Underscore (use native JavaScript equivalents; WordPress is actively removing Lodash usage)
* Moment.js (in maintenance mode; prefer native `Intl.DateTimeFormat` or lightweight alternatives)
